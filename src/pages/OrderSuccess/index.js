            ...
            <Container className={cx('wrapper')}>
                <Row ref={sumaryForm}>
                    <Col sm={12} md={6} lg={8} className={cx('left')}>
                        ...
                        <span>
                            Any questions about your order, contact us via e-mail theanhmgt66@gmail.com Everyday from
                            10:00am-7:00pm We’d love to hear from you
                        </span>
                        <Row className={cx('left-body')}>
                            ...
                            <Col lg={7}>
                                <div className={cx('left-body-title')}>Address Shipping</div>
                                <p className={cx('left-body-content')}>
                                    {`${address.home_number} ${address.street} ${address.city} ${address.country}`}
                                </p>
                                <div className={cx('left-body-title')}>Delivery option</div>
                                <p className={cx('left-body-content')}>{receipt?.status?.delivery_method}</p>
                            </Col>
                        </Row>
                        <div className={cx('left-footer')}>
                            ...
                            <Button outline to={'/dashboard/myorders'}>
                                GO TO MY ORDER
                            </Button>
                            <Button outlineGray onClick={handlePrint}>
                                PRINT SUMARY
                            </Button>
                        </div>
                    </Col>
