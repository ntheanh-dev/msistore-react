...
const Checkout = () => {
    ...
    const nextToPayment = () => {
        const isValidForm = Object.values(values).every(
                    ...
                    {checkoutProcess === 1 ? (
                        <>
                            ...
                            <form ref={formRef}>
                                {INPUTS.map((input, index) => (
                                    <FormInput key={index} {...input} value={values[input.name]} onChange={onChange} />
                                ))}
                            </form>
                            ...
                            {true ? (
                                <div className={cx('footer-left')}>
                                    <Button onClick={nextToPayment} primary>
                                        Next
                                    </Button>
                                </div>
                            ) : (
                                <div className={cx('footer-left')}>
                                    <Button onClick={handleVerify} primary>
                                        Verify Phone Number
                                    </Button>
                                </div>
                            )}
                        ...
                        <div className={cx('payment')}>
                                ...
                                >
                                    <Row className={cx('payment-option-head')}>
                                        <Col
                                            className={cx(
                                                'border-right',
                                                paymentMethod === ele.type && 'active-border-right',
                                            )}
                                            xs={3}
                                            md={3}
                                            lg={2}
                                        >
                                            <div className={cx('payment-option-head-icon')}>{ele.svg}</div>
                                        </Col>
                                        <Col xs={7} md={7} lg={9} className={cx('payment-option-head-name')}>
                                            <p>{ele.type}</p>
                                        </Col>
                                        <Col xs={2} md={2} lg={1}>
                                            {paymentMethod === ele.type ? (
                                                <IoIosCheckmarkCircle className={cx('payment-option-icon-checked')} />
                                            ) : (
                                                <FaRegCircle />
                                            )}
                                        </Col>
                            ...
                            <div className={cx('payment-btns')}>
                                <Button primary onClick={() => setCheckoutProcess(1)}>
                                    Back
                                </Button>
                    ...
                    <div className={cx('right')}>
                        {checkoutProcess >= 2 && (
                            <>
                                ...
                                <br />
                                <span>{`${values.home_number}, ${values.street}, ${values.city}, ${values.country}`}</span>
                                <br />
                        ...
                        {show && (
                            <div className={cx('add-product')}>
                                <Button primary small to={'/yourcart'}>
                                    Add more product
                                </Button>
                            </div>
                        )}
