...
export const getUserInfo = createAsyncThunk('userInfo,getUserInfo', async (data, { rejectWithValue }) => {
    try {
        let user_info = await authAPI().get(endpointsV2['current-user']);
...
export const update = createAsyncThunk('address,updateAddress', async (data, { rejectWithValue }) => {
    try {
...
export const create = createAsyncThunk('address,createAddress', async (data, { rejectWithValue }) => {
    try {
